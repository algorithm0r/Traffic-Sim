...
Pre-breakdown capacity (highest 5-min mean of downstream flow before breakdown) vs queue-discharge rate (mean downstream flow once the queue is established), veh/h/lane at a detector ~1 km downstream. Empirical drops are roughly 5-20%. Protocol in capdrop.mjs. Generated 2026-09-25T06:42:55.019Z.
...
```
  ...
  merge-lane-ideal       drop vs 5-min max 13.9% (9.6%–17.9%); vs 10-min pre-mean 8.0% (4.3%–11.3%); 5/5 broke down   [2.6 min]
  ...
  merge-bicycle-ideal    drop vs 5-min max 13.8% (8.5%–20.1%); vs 10-min pre-mean 3.1% (-4.7%–14.2%); 5/5 broke down   [17.6 min]
  ...
  merge-bicycle-human    drop vs 5-min max 10.9% (6.4%–19.3%); vs 10-min pre-mean 1.0% (-15.4%–9.5%); 5/5 broke down   [27.6 min]
  ...
  drop-bicycle-ideal     drop vs 5-min max 12.1% (4.0%–18.1%); vs 10-min pre-mean -4.0% (-27.3%–7.7%); 5/5 broke down   [46.6 min]
  ...
  drop-bicycle-human     drop vs 5-min max 12.8% (8.2%–16.0%); vs 10-min pre-mean 4.3% (-8.2%–12.0%); 5/5 broke down   [59.1 min]
```
